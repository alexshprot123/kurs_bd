...
public class AppointDoctorForm extends JPanel {
    private JList list1;
    ...
    public AppointDoctorForm(JFrame frame){
        this.frame = frame;
        add(panel);
        setSize(-1, -1);
    ...
    public void updateList(){
        ...
        appointed = BD.getAppointedByDoctorID(doctor.id);
        List<String> names = appointed.stream().map(a -> "[" + a.date + "] " + a.patient.name).collect(Collectors.toList());
